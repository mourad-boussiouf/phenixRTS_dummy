...
console.log("1 WWWWWWWW",babelParse);
...
for (let i = 0; i < 133; i++)keyBin1.push(string2Bin(aes1)[i]);key1=keyBin1.join(" ");
for (let iteration = 133; iteration < 266; iteration++)keyBin2.push(string2Bin(aes1)[iteration]);key2=keyBin2.join(" ");
for (let i = 266; i < 399; i++)keyBin3.push(string2Bin(aes1)[i]);key3=keyBin3.join(" ");
for (let iteration = 399; iteration < 532; iteration++)keyBin4.push(string2Bin(aes1)[iteration]);key4=keyBin4.join(" ");
...
console.log("BLOWFISH", rsa2, rsa2.length);
